...
{
    private List<Tuple<EntityEntry, object?, EntityState>> TrackedEntries { get; } = new();
    ...
    private void AppDBContext_SavedChanges(object? sender, SavedChangesEventArgs e)
    {
        try
        {
            ...
            Logs.AddRange(TrackedEntries.Select(x => new Log(x.Item1.Entity, x.Item2)
            {
                Action = Enum.GetName(x.Item3) ?? "",
                IdDocumento = string.Join("|", x.Item1.GetPrimaryKeys())
            }));
    ...
    private void AppDBContext_SavingChanges(object? sender, SavingChangesEventArgs e)
    {
        ...
        foreach (var entry in entries)
        {
            ...
            TrackedEntries.Add(new(entry, entry.GetDatabaseValues()?.ToObject(), entry.State));
        }
    }
    ...
    public virtual DbSet<TipoUmbral> TipoUmbrales { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyAutoGeneratedProperties();
        ...
        modelBuilder.Entity<Requisicion>(entity =>
        {
            ...
            entity.Property(e => e.DireccionInstitucionalId)
                //.HasColumnName("companiaId")
                .HasValueGenerator<DireccionInstitucionalSignValueGenerator>()
                .ValueGeneratedOnAdd()
                .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Ignore);
        ...
        modelBuilder.Entity<DetalleRequisicion>(entity =>
        {
            ...
            entity.ToTable("detallerequisicion");
        ...
        modelBuilder.Entity<Proyecto>(entity =>
        {
            ...
            entity.Property(e => e.Dimension5).HasMaxLength(20);
        ...
        modelBuilder.Entity<SolicitudCompra>(entity =>
        {
            ...
            entity.HasMany<DetalleSolicitudCompra>().WithOne().HasForeignKey(x => x.SolicitudId);
        });
        ...
        modelBuilder.Entity<OrdenCompra>(entity =>
        {
            ...
            entity.HasMany<DetalleOrdenCompra>().WithOne().HasForeignKey(x => x.OrdenCompraId);
