...
namespace API_PGI.Controllers.CircuitoAprobacion
{
    ...
    [ApiController]
    [JwtAuthorize]
    public class EtapaCircuitoController : ControllerBase
    {
        private readonly IEtapaCircuito _Repo;
        private IAuth _Auth { get; }

        public EtapaCircuitoController(IEtapaCircuito BaseSystemData, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] EtapaCircuito entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] EtapaCircuito entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                ...
                var builder = new QueryBuilder<EtapaCircuito>()
