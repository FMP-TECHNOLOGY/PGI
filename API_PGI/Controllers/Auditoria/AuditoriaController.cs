...
namespace API_PGI.Controllers.Auditorias
{
    ...
    public class AuditoriaController : ControllerBase
    {
        ...
        public AuditoriaController(IAuditoria Auditoria, IAuth auth)
        {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Auditoria entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                ...
                var items = _Auditoria.GetPaginated(gridifyQuery);
                return Ok(new ResponseModel()
                {
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Auditoria.Find(x => x.Id == id);
