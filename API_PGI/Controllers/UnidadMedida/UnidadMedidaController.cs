...
namespace API_PGI.Controllers.UnidadMedidas
{
    ...
    public class UnidadMedidaController : ControllerBase
    {
        ...
        public UnidadMedidaController(IUnidadMedida UnidadMedida, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] UnidadMedida entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] UnidadMedida entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<UnidadMedida>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(UnidadMedida.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _UnidadMedida.Find(x => x.Id == id);
