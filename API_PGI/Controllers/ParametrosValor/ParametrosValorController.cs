...
namespace API_PGI.Controllers.ParametrosValors
{
    ...
    public class ParametrosValorController : ControllerBase
    {
        ...
        public ParametrosValorController(IParametrosValor ParametrosValor, IAuth auth)
        {
            _ParametrosValor = ParametrosValor;
            _Auth = auth;
        }

        [HttpPost]
        public IActionResult post([FromBody] ParametrosValor entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] ParametrosValor entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<ParametrosValor>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(ParametrosValor.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _ParametrosValor.Find(x => x.Id == id);
