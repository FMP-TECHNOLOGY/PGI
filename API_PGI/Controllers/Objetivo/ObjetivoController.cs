...
namespace API_PGI.Controllers.Objetivos
{
    ...
    public class ObjetivoController : ControllerBase
    {
        ...
        public ObjetivoController(IObjetivo Objetivo, IAuth auth)
        {
            _Objetivo = Objetivo;
            _Auth = auth;
        }
        ...
        [HttpPost]
        public IActionResult post([FromBody] Objetivo entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Objetivo entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                ...
                var items = _Objetivo.GetPaginated(gridifyQuery);
                return Ok(new ResponseModel()
                {
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Objetivo.Find(x => x.Id == id);
