...
namespace API_PGI.Controllers.Roles
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(IRole Role, IAuth auth)
        {
            _Role = Role;
            _Auth = auth;
        }
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Role entity)
        {
            try
            {
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Role.Find(x => x.Id == id);
