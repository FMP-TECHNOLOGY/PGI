...
namespace API_PGI.Controllers.Peis
{
    ...
    public class PeiController : ControllerBase
    {
        ...
        public PeiController(IPei Pei, IAuth auth)
        {
            _Pei = Pei;
            _Auth = auth;
        }
        ...
        [HttpPost]
        public IActionResult post([FromBody] Pei entity)
        {
            try
            {
                _Pei.AddOrUpdateSaving( entity);
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Pei entity)
        {
            try
            {
