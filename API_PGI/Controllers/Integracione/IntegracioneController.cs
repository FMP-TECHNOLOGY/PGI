...
namespace API_PGI.Controllers.Integraciones
{
    ...
    public class IntegracioneController : ControllerBase
    {
        ...
        public IntegracioneController(IIntegracione Integracione, IAuth auth)
        {
            _Integracione = Integracione;
            _Auth = auth;
        }

        [HttpPost]
        public IActionResult post([FromBody] Integracione entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Integracione entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<Integracione>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(Integracione.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Integracione.Find(x => x.Id == id);
