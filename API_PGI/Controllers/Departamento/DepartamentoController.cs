...
namespace API_PGI.Controllers.Departamentos
{
    ...
    public class DepartamentoController : ControllerBase
    {
        ...
        public DepartamentoController(IDepartamento Departamento, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] Departamento entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Departamento entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<Departamento>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(Departamento.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Departamento.Find(x => x.Id == id);
