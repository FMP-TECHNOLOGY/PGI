...
namespace API_PGI.Controllers.SolicitudCompras
{
    ...
    public class SolicitudCompraController : ControllerBase
    {
        ...
        public SolicitudCompraController(ISolicitudCompra SolicitudCompra, IAuth auth)
        {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] SolicitudCompra entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<SolicitudCompra>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(SolicitudCompra.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _SolicitudCompra.Find(x => x.Id == id);
