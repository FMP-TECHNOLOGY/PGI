...
namespace API_PGI.Controllers.EstadoSolicituds
{
    ...
    public class EstadoSolicitudController : ControllerBase
    {
        ...
        public EstadoSolicitudController(IEstadoSolicitud EstadoSolicitud, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] EstadoSolicitud entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] EstadoSolicitud entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<EstadoSolicitud>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(EstadoSolicitud.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _EstadoSolicitud.Find(x => x.Id == id);
