...
namespace API_PGI.Controllers.DetalleSolicitudCompras
{
    ...
    [ApiController]
    [Authorize]
    public class DetalleSolicitudCompraController : ControllerBase
    {
        private readonly IDetalleSolicitudCompra _DetalleSolicitudCompra;
        private IAuth _Auth { get; }

        public DetalleSolicitudCompraController(IDetalleSolicitudCompra DetalleSolicitudCompra, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] DetalleSolicitudCompra entity)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] DetalleSolicitudCompra entity)
        {
            try
            {
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                ...
                var items = _DetalleSolicitudCompra.GetPaginated(gridifyQuery);
                return Ok(new ResponseModel()
                {
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _DetalleSolicitudCompra.Find(x => x.Id == id);
