...
namespace API_PGI.Controllers.DocumentosEvidencias
{
    ...
    public class DocumentosEvidenciaController : ControllerBase
    {
        ...
        public DocumentosEvidenciaController(IDocumentosEvidencia DocumentosEvidencia, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] DocumentosEvidencia entity)
        {
            try
            {
                _DocumentosEvidencia.AddSaving(_Auth.CurrentUser, entity);
        ...
        public IActionResult Put([FromBody] DocumentosEvidencia entity)
        {
            try
            {
                ...
                _DocumentosEvidencia.UpdateSaving(_Auth.CurrentUser, entity);
