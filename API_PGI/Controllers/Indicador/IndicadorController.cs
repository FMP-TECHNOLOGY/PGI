...
namespace API_PGI.Controllers.Indicadors
{
    ...
    public class IndicadorController : ControllerBase
    {
        ...
        public IndicadorController(IIndicador Indicador, IAuth auth)
        {
        ...
        [HttpPost]
        public IActionResult post([FromBody] Indicador entity)
        {
            try
            {
                _Indicador.AddSaving( entity);
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Indicador entity)
        {
            try
            {

                _Indicador.UpdateSaving( entity);
        ...
        public IActionResult GetAll([FromQuery] GridifyQuery gridifyQuery)
        {
            try
            {
                var builder = new QueryBuilder<Indicador>()
                             .AddQuery(gridifyQuery)
                             .AddCondition($"{nameof(Indicador.CompaniaId)}={_Auth.CurrentUser?.CompaniaId}")
                ;
        ...
        public IActionResult GetAll(string id)
        {
            try
            {
                var valor = _Indicador.Find(x => x.Id == id);
