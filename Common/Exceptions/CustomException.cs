...
namespace Common.Exceptions
{
    ...
    {
        public virtual int StatusCode { get; set; } = 400;
        public virtual string ErrorCode { get; set; } = "40x100";
        string? _DevMessage;
        public virtual string DevMessage { get => _DevMessage ?? Message; set => _DevMessage = value; }
        ...
        public virtual CustomResponse ToCustomResponse()
        {
